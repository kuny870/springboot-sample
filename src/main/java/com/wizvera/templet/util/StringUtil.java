...
import static com.wizvera.templet.util.Args.notNull;
...
public class StringUtil {
	...
	public static Set<String> splitAsSet(	String str,
											String delim) {
		if ( str == null ) {
			return null;
		}
	...
	public static String collectionAsString(Collection<String> set,
											String delim) {
		if ( set == null ) {
			return null;
		}
	...
	public static String getRelativeRequestUri(	String servletPath,
												String requestUri) {
		String path = "";
	...
	public static String concatObjects(	Object o1,
										Object... objs) {
		StringBuilder sb = new StringBuilder();
		sb.append(o1);
		for (Object obj : objs) {
	...
	public static String concatObjectsCap(	int cap,
											Object o1,
											Object... objs) {
